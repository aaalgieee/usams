...
function Calendar() {
  return (
    <div>
      ...
      <div class="max-w-9xl mx-auto mt-20">

        <div class="bg-white rounded-lg shadow-md h-300">
          <div class="flex items-center justify-between bg-blue-500 text-white py-4 px-4 rounded-t-lg">
